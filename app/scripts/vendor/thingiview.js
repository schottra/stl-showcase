var ROTATE_INCREMENT = 0.025;
var PLANE_WIDTH = 200;
var PLANE_HEIGHT = 200;
...
Thingiview = function(containerId) {
  ...
  rotateLoop = function() {
    targetXRotation += ROTATE_INCREMENT;
    sceneLoop();
  }
  ...
  function loadPlaneGeometry() {
    ...
    plane = new THREE.Mesh(new Plane(PLANE_WIDTH, PLANE_HEIGHT, 10, 10), new THREE.MeshBasicMaterial({color:0xafafaf,wireframe:true}));
